    ...
    tick() {
        ...
        // !!! IMPLEMENT ME
            switch(IR){ 
                ...
                //or use this below but repeat yourself in other cases
                // this.reg[SP]--;
                // this.ram.write(this.reg[SP], this.reg[operandA]);
                // console.log(PUSH.toString(2));
                break;
                ...
                // console.log(this.PC, this.reg, operandA, this.reg[operandA])
